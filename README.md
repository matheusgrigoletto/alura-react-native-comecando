...
Este projeto implementa a tela de detalhes da cesta do e-commerce _orgs_. Nesta tela são mostrados dados estáticos do nome da cesta, fazenda, preço e itens da cesta.
...
Uma guia no navegador irá abrir, geralmente [neste endereço](http://localhost:19000/).
